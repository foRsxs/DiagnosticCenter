...
class PaymentCards extends Component {
	...
	render() {
		...
		return (
			<Container>
				<Header backButton={true} text={t('recordings:card_payment')} navigation={navigation} />
				<Content style={styles.content}>
					<View style={styles.itemElement}>
						<Text style={styles.textStyle}>{t('recordings:payment_by_saved_card')}</Text>
					</View>
					{this.renderCards()}
					<View style={styles.addNewCardContainer}>
						<View style={styles.itemElement}>
							<Text style={styles.textStyle}>{t('recordings:add_new_card')}</Text>
						</View>
					...
					<View style={styles.bankCardContainer}>
						<View style={styles.itemElement}>
							<Text style={styles.textStyle}>{t('recordings:payment_without_saving_a_card')}</Text>
						</View>
...
export default compose(withNamespaces(['recordings', 'common']), withNavigationFocus, connect(mapStateToProps, mapDispatchToProps))(PaymentCards);
